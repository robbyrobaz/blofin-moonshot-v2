#!/usr/bin/env python3
"""Insert 2026-03-26 Moonshot Scout variants into tournament queue."""
...
def main():
    ...
    print(f"\nModel IDs:")
    for model_id, cfg in inserted:
        print(f"  {model_id}  {cfg['direction']:5s}  {cfg['model_type']:12s}  {config_path.stem}")
